...
<meta charset="utf-8" />
    ...
    <link rel="icon" href="./img/logo/LogoCorto.ico" />
...
<img src="./img/logo/LogoCorto_Final.svg" alt="Logo"  class="logo-main" >
    ...
    <p>
        Los contenidos privados de las páginas web a los que los usuarios acceden a través de los servicios de este WEBSITE no son controlados por TripOut.com Por lo que en ningún caso TripOut.com se hace 
    ...
    <p>
        ...
        facilitados a los usuarios, o por los contenidos accesibles a través del WEBSITE, que sean contrarios a la ley, la moral, la buena fe y al orden público, infrinjan derechos de propiedad intelectual,
