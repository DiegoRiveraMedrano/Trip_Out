...
<body>
    ...
    <main class="main">
        <h1>Crea tu ruta y descubre tu nuevo lugar favorito</h1>
        <div class="buttons">
            <a href="https://youtu.be/u8D9ZGg5ink" class="button">¿Qué es?</a>
            <a href="Cuestionario.php" class="button">Crear ruta</a>
        </div>
    </main>
</body>
<footer>
